...
const Comments = ({user, setMsg}) => {
    ...
    return ( 
        <div className="my-3 min-h-[83vh] md:min-h-[75vh]">
            ...
            <form onSubmit={handleSubmit} className="flex items-center justify-center md:w-screen gap-3 mt-3 fixed bottom-0 mb-14">
                    <textarea value={userComment} onChange={(e) => setUserComment(e.target.value)} className="border-2 w-72 lg:w-96 h-16"></textarea>
